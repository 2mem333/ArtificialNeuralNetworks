...
#include "RegressionSingleLayer.h"
...
private: System::Windows::Forms::Button^ StartRegressionSLayer;
private: System::Windows::Forms::Label^ label9;
private: System::Windows::Forms::Label^ label8;
private: System::Windows::Forms::DataVisualization::Charting::Chart^ chart1;
private: System::Windows::Forms::CheckBox^ momentumCheckbox;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->StartRegressionSLayer = (gcnew System::Windows::Forms::Button());
			...
			this->momentumCheckbox = (gcnew System::Windows::Forms::CheckBox());
			...
			// tabPage5
			// 
			this->tabPage5->Controls->Add(this->StartRegressionSLayer);
			...
			// 
			// StartRegressionSLayer
			// 
			this->StartRegressionSLayer->Location = System::Drawing::Point(309, 87);
			this->StartRegressionSLayer->Name = L"StartRegressionSLayer";
			this->StartRegressionSLayer->Size = System::Drawing::Size(209, 33);
			this->StartRegressionSLayer->TabIndex = 20;
			this->StartRegressionSLayer->Text = L"Start Regressing";
			this->StartRegressionSLayer->UseVisualStyleBackColor = true;
			this->StartRegressionSLayer->Click += gcnew System::EventHandler(this, &Main::StartRegressionSLayer_Click);
			// 
			// label9
			// 
			this->label9->AutoSize = true;
			this->label9->Font = (gcnew System::Drawing::Font(L"Century Gothic", 9, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(162)));
			this->label9->Location = System::Drawing::Point(306, 52);
			this->label9->Name = L"label9";
			this->label9->Size = System::Drawing::Size(183, 18);
			this->label9->TabIndex = 19;
			this->label9->Text = L"Regression Single-Layer";
			// 
			// label8
			// 
			...
			this->label8->Size = System::Drawing::Size(203, 18);
			this->label8->TabIndex = 18;
			this->label8->Text = L"Regression with multi-layer";
			// 
			// label1
			// 
			...
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(141, 46);
			...
			// StartRegression
			// 
			this->StartRegression->Location = System::Drawing::Point(10, 87);
			...
			// tabPage3
			// 
			this->tabPage3->Controls->Add(this->momentumCheckbox);
			...
			this->chart1->Location = System::Drawing::Point(875, 382);
			this->chart1->Name = L"chart1";
			series1->ChartArea = L"ChartArea1";
			series1->Legend = L"Legend1";
			series1->Name = L"Series1";
			this->chart1->Series->Add(series1);
			this->chart1->Size = System::Drawing::Size(408, 169);
			this->chart1->TabIndex = 26;
			this->chart1->Text = L"chart1";
			// 
			// momentumCheckbox
			// 
			this->momentumCheckbox->AutoSize = true;
			this->momentumCheckbox->Location = System::Drawing::Point(10, 90);
			this->momentumCheckbox->Name = L"momentumCheckbox";
			this->momentumCheckbox->Size = System::Drawing::Size(138, 23);
			this->momentumCheckbox->TabIndex = 23;
			this->momentumCheckbox->Text = L"Use Momentum";
			this->momentumCheckbox->UseVisualStyleBackColor = true;
			// 
			// Main
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(120, 120);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Dpi;
			this->ClientSize = System::Drawing::Size(1295, 587);
...
private: System::Void StartLearningSingleLayer_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	trainingtime->Text = inf.time.ToString();;

	chart1->Series["Series1"]->Points->Clear();
	chart1->Series["Series1"]->ChartType = System::Windows::Forms::DataVisualization::Charting::SeriesChartType::Line;
	chart1->Series["Series1"]->Color = System::Drawing::Color::Red;

	for (int i = 0; i < inf.cycle; i++) {
		chart1->Series["Series1"]->Points->AddXY(i, inf.errorList[i]);
	}
...
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	info inf;
	if (momentumCheckbox->Checked == true)
	{
		inf = network.StartLearningMomentum(minError, maxEpoch, lc);
	}
	else
	{
		inf = network.StartLearning(minError, maxEpoch, lc);
	}
...
private: System::Void StartRegressionSLayer_Click(System::Object^ sender, System::EventArgs^ e) {
	float minError = System::Convert::ToSingle(textBox2->Text);
	float maxEpoch = System::Convert::ToSingle(textBox3->Text);
	float lc = System::Convert::ToSingle(textBox4->Text);
	int hiddenNeuronCount = System::Convert::ToInt32(textBox5->Text);

	RegressionSingleLayer network(addedInputCount, 1);
